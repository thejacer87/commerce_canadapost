...
class CanadaPost extends ShippingMethodBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['option_codes']['codes'] = [
      ...
      '#default_value' => $this->configuration['option_codes']['codes'],
      '#description' => $this->t(
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configuration['option_codes']['codes'] = $values['option_codes']['codes'];
  ...
  public function calculateRates(ShipmentInterface $shipment) {
    ...
    $option_codes = $this->configuration['option_codes']['codes'];
